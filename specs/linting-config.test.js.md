# Snapshot report for `specs/linting-config.test.js`
...
> Snapshot 1
    ...
    example.js␊
       ...
       23:10  warning  'functionWithoutJSDocWarningsBecauseTheSectionWasCompletelyExcluded' is defined but never used                                 no-unused-vars␊
       ...
       35:71  warning  'params' is defined but never used                                                                                             no-unused-vars␊
       40:1   warning  Invalid JSDoc tag name "note"                                                                                                  jsdoc/check-tag-names␊
       42:17  warning  'a' is defined but never used                                                                                                  no-unused-vars␊
       ...
       50:7   warning  'variable' is assigned a value but never used                                                                                  no-unused-vars␊
    ...
    ␊
    ✖ 77 problems (37 errors, 40 warnings)␊
