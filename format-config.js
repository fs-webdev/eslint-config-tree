...
FS.writeFile('./demo/test/snapshots/new-lint-final-config.json', JSON.stringify({ ...finalConfig, rules: formattedRules }, null, 2), (err) => { if (err) console.log('There was an error writing to new-lint-final-config.json file:', err); });
