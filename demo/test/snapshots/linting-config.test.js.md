...
> Snapshot 1
    ...
    test/example.test.js␊
      11:5   warning  Expected an assignment or function call and instead saw an expression  @babel/no-unused-expressions␊
      11:15  error    Matchers must be called to assert                                      jest/valid-expect␊
      14:3   warning  Test has no assertions                                                 jest/expect-expect␊
      17:11  error    'browser' is not defined                                               no-undef␊
    ␊
    test/example.ts␊
    ...
    ␊
    ✖ 94 problems (51 errors, 43 warnings)␊
